...
|`-`Â (minus sign)|Excludes terms from the search results.|`site:news.com -inurl:sports`|Search for news articles on news.com excluding sports-related content.|
...
Here are some common examples of Google Dorks, for more examples, refer to theÂ [Google Hacking Database](https://www.exploit-db.com/google-hacking-database):
...
- Uncovering Configuration Files:
    ...
    - `site:example.com (ext:conf OR ext:cnf)`Â (searches for extensions commonly used for configuration files)
