...
![Pasted image 20250327174317.png](../../IMAGES/Pasted%20image%2020250327174317.png)
...
![Pasted image 20250328150658.png](../../IMAGES/Pasted%20image%2020250328150658.png)
...
- The binary checks for the environment variableÂ `admin`Â usingÂ `getenv("admin")`.
- IfÂ `admin`Â is not set (`nil`), it printsÂ `"Not an Admin"`Â and exits.
- **Goal**: Trick the binary into thinkingÂ `admin`Â is set to trigger privileged code (likely a root shell or action).
